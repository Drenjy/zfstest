...
# directories if the passed argument is '/usr/bin/mkdir', or to remove
# all created empty directories if the passed argument is '/usr/bin/rm -rf'.
# Note: since unlink is not usable in ZFS filesystem, we use 'rm' instead
#       of 'unlink' here.
#
# $1 command used for testing:/usr/bin/mkdir or /usr/bin/rm -rf 
#
